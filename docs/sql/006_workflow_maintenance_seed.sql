...
VALUES
  ...
  ($$zap_175$$, $$Zoho CRM Academy onboarding → PostgreSQL$$, $$Zapier$$, $$Zoho CRM$$, $$PostgreSQL; Zoho CRM; Zoho Mail$$, $$new_or_updated_module_entry$$, $$Create/update Academy onboarding data, send the onboarding email and persist completion evidence$$, $$Eamonn$$, $$partially_audited$$, $$high$$, $$Zoho CRM contact; academy_students$$, $$academy_students; Zoho CRM fields; Zoho Mail outbound; academy_onboarding_completions$$, $$zapier_user$$, $$Zapier defaultdb connection$$, null, DATE '2026-05-31', DATE '2026-06-30', $$Zoho CRM Academy onboarding → PostgreSQL$$, $$Processor and completion source are version-controlled; new post-change runtime completion remains unproven.$$),
